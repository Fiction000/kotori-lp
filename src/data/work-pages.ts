...
export const workPages: WorkPage[] = [
  {
    ...
    imageAlt: '海辺の砂に残る足跡と青い傘を描いたイラスト',
    seo: {
      title: '『こころ』夏目漱石｜あらすじ・読みどころ｜コトリ',
      description: '夏目漱石『こころ』のあらすじと読みどころ。「私」と先生の関係をたどり、青空文庫の作品情報と公開テキストを案内します。',
 ...
 },
 {
  ...
  imageAlt: '青い円光の前に墓標と白い花、閉じた青い傘を描いたイラスト',
  seo: {
   title: '夏目漱石『夢十夜』あらすじ・読みどころ・作品情報',
   description: '夏目漱石『夢十夜』のあらすじ、読みどころ、青空文庫の作品情報を紹介。第一夜から第十夜までの幻想的な場面を味わうための作品案内です。',
 ...
 },
 {
  ...
  imageAlt: '線路を走る蒸気機関車と丘の学校を描いたイラスト',
  seo: {
   title: '『坊っちゃん』夏目漱石｜あらすじ・読みどころ｜コトリ',
   description: '夏目漱石『坊っちゃん』のあらすじと読みどころ。四国の学校を舞台にした語り手と人々のやりとりを、青空文庫の作品情報とともに紹介します。',
